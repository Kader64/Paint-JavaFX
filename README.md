...
- Java
- JavaFX
- HTML5 Canvas (JavaFX Canvas API)
- SwingFXUtils + ImageIO (eksport obrazów)

---

Projekt stanowi prostą wersję klasycznego programu Paint, rozszerzoną o dodatkowe kształty (gwiazda, serce, trójkąt).
